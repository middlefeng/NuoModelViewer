...
@implementation NuoCameraRayEmitter
{
...
- (void)setupPipeline
{
    ...
    _pipeline = [[NuoComputePipeline alloc] initWithDevice:_device withFunction:@"camera_ray_emit"
                                             withParameter:NO];
    _pipeline.name = @"Camera Ray Emit";
}
